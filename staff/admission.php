...
if (isset($_POST['submit'])) {
  ...
  $update2="UPDATE `p_insure` SET `date` = '$date',`uhid` = '$uhid',`ipd` = '$ipd',`ward/icu` = '$ward',`uhid` = '$uhid',`bed/room` = '$bed',`aadhar` = '$aadhar',`time` = '$time',`occ` = '$occ',`em_c` = '$em_c',`mlc/nmlc` = '$mlc',`i_company` = '$i_company',`relationship` = '$relationship',`ad_c` = '$ad_c',`icd`='$icd',`s_discharge` = '$s_discharge',`p_diagnosis` = '$p_diagnosis',`f_diagnosis` = '$f_diagnosis',`c_death` = '$c_death',`insure` = '$insure' WHERE `id` = '$id'";
  $conn->query($update2);
  ...
  if (($_FILES['img']["size"]>0)) { 
    ...
    $update1 = "UPDATE `p_init` SET img='$image' where id = $id";
    $conn->query($update1);
  ...
  if (isset($_POST["imageData"]) && !empty($_POST["imageData"])) {
    ...
    $updateQuery = "UPDATE `p_init` SET img = ? WHERE id = ?";
  ...
  $update3="UPDATE `p_init` SET `p_his` = '$p_his',`resp` = '$resp',`cvs` = '$cvs',`rs` = '$rs',`r_his` = '$r_his',`m_his` = '$m_his',`habit` = '$habit', `invest` = '$invest',`nutrition` = '$nutrition',`height`='$height'  WHERE `id` = '$id'";
  $conn->query($update3);

  $sql3 = "SELECT * FROM p_init WHERE id = '$id';";
    ...
    <div class="container">
        ...
        <a href="eye_forms.php?id=<?php echo $id; ?>" class="btn btn-success m-2">Dashboard</a>
          ...
          <form id="form" action="" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-2">
                <label class="form-label">INSURED
                </label>
              ...
              <div class="col-md-2">
                <label class="form-label">Ward/ICU:</label>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-2">
                <label class="form-label" for="time_ad">Time of Admission :</label>
              ...
              <div class="col-md-2">
                <label class="form-label">MLC/NMLC</label>
                <input name="mlc/nmlc" type="text" class="form-control" id="MLC/NMLC" value="<?php echo $res2['mlc/nmlc']; ?>">
              </div>
              <div class="col-md-3">
                <label class="form-label">Name Of Insured Company</label>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <label class="form-label">Past History(Medical & Surgical) :</label>
                    <textarea name="p_his" type="text" style="height: 100px;" class="form-control live-fetch" id="treatment" placeholder="Treatment"  data-column="p_his" data-table="p_init"><?php echo $res3['p_his']; ?></textarea><div class="dropdown-container"></div>
                  </div>
                  <div class="col-lg-4">
              ...
              <div class="container">
                <div class="row">
                <div class="col-lg-4">
                  <label class="form-label">Relevant Family History:</label>
                  <textarea name="r_his" type="text" style="height: 100px;" class="form-control live-fetch" id="examination_finding_text" placeholder=""  data-column="r_his" data-table="p_init"><?php echo $res3['r_his']; ?></textarea><div class="dropdown-container"></div>
                </div>
                <div class="col-lg-4">
                  <label class="form-label">Medication History:</label>
                  <textarea name="m_his" type="text" style="height: 100px;" class="form-control live-fetch" id="treatment" placeholder=""  data-column="m_his" data-table="p_init"><?php echo $res3['m_his']; ?></textarea><div class="dropdown-container"></div>
                </div>
                <div class="col-lg-4">
                  <label class="form-label">Any Habit-(Tobacco/Alcohol/Smoking/Other):</label>
                  <textarea name="habit" type="text" style="height: 100px;" class="form-control live-fetch" id="localexam" placeholder="Any Habit"  data-column="habit" data-table="p_init"><?php echo $res3['habit']; ?></textarea><div class="dropdown-container"></div>
                </div>
                <div class="col-lg-4">
                  <label class="form-label">Relevant Previous Investigation/Report:</label>
                  <textarea name="invest" type="text" style="height: 100px;" class="form-control live-fetch" id="localexam" placeholder="Relevant Previous Investigation/Report"  data-column="invest" data-table="p_init"><?php echo $res3['invest']; ?></textarea><div class="dropdown-container"></div>
                </div>
                <div class="col-lg-4">
                  <label class="form-label">Immunization Record and Nutritional & Growth History:</label>
                  <textarea name="nutrition" type="text" style="height: 100px;" class="form-control live-fetch" id="localexam" placeholder="Immunization Record and Nutritional & Growth History"  data-column="nutrition" data-table="p_init"><?php echo $res3['nutrition']; ?></textarea><div class="dropdown-container"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container mt-3">
            <div class="row">
              ...
              <div class="container mt-3">
            <div class="col-md-2">
            <label class="form-label ">Numeric Pain Scale</label>
          ...
          <div class="container mt-3">
            <div class="row">
              ...
              <div class="col-sm-2">
                <label class="form-label">C.N.S:</label>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4">
      <label class="form-label">Plan of Care Rx :</label>
...
<div class="container">
  <div class="row">
    <div class="col-md-3">
      ...
      <input type="hidden" name="cam-img" id="cam-img">
    </div>
    <div class="col-lg-6">
      <div class="row">
        <div class="col-7">
      ...
      <input type="datetime-local" name="date_time" id="consultant" class="form-control" placeholder="" value="<?php echo $res4['date_time']; ?>" ><br>
            ...
            <div class="row">
              <div class="col mt-2">
                ...
                <a href="admission_print.php?id=<?php echo $id; ?>" class="btn btn-outline-primary ml-auto">Print</a>
              </div>
            </div>
          </form>
        </div>
      ...
      <script>
       ...
       <script>
        function update() {
            $.ajax({
                type: 'post',
                url: 'admin_update.php?id=<?= $res['id'] ?>',
                data: $('#form').serialize(),
                success: function() {
