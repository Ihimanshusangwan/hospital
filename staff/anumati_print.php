...
<button type="button" class="btn btn-danger mt-4 noprint" onclick="window.print()" id="print">Print</button>
        <a href="consent.php?id=<?php echo $id; ?>" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
    </div>
    <?php include_once("../header/images.php") ?>
    <h3 class="text-center text-dark my-3 ">अनुमतीपत्र</h3>
...
<p class="style10"> १०. वैदकीय ज्ञानाच्या अभिवृद्धीसाठी उपचार / शस्त्रक्रिया करतांना छायाचित्रे (फोटोग्राफ्स / ट्रान्सपनीज ) दृश्य किती प्रदर्शित अथवा प्रकाशित करण्यात माझी / आमची अनुमती आहे. मी / आम्ही असे गृहीत धरतो कि , अशा प्रकाशनात / प्रदर्शनात माझी / रुग्णाची ओळख दिली जाणार नाही . वरील सर्वे कलमे मी / आम्ही वाचली आहे . ती मला / आम्हाला समजली आहेत . व मला / आम्हाला मान्य आहेत व ती माझ्यावर /आम्हावर बंधनकारक आहेत. तरी मी / आम्ही  रुग्णालयाच्या अधिकाऱ्यांना मला /
   <div class="row">
    ...
    <div class="col-4"><p class="style10"><?php echo $row6['a'];?></div>
...
<p class="style10"> <div class="row">
  ...
  <div class="col-4"><p class="style10"><?php echo $row6['b'];?></div>
  <div class="col-2"><p class="style10">  सही / अंगठा :</p></div>
  <div class="col-4"><p class="style10"><?php echo $row6['c'];?></div>
  <div class="col-2 mt-2"><p class="style10">  रुग्णांशी  नाते:</p></div>
  <div class="col-4 mt-2"><p class="style10"> <?php echo $row6['d'];?></div>
  <div class="col-2 mt-2"><p class="style10">  तारीख :</p></div>
  <div class="col-4 mt-2"><p class="style10"><?php echo $row6['e'];?></div>
  ...
  <div class="row">
  <div class="col-2"><p class="style10"> नाव :</p></div>
  <div class="col-4"><p class="style10"><?php echo $row6['f'];?></div>
  <div class="col-2"><p class="style10">  सही / अंगठा :</p></div>
  <div class="col-4"><p class="style10"><?php echo $row6['g'];?> </div>
  <div class="col-2 mt-2"><p class="style10">  रुग्णांशी  नाते:</p></div>
  <div class="col-4 mt-2"><p class="style10"><?php echo $row6['h'];?></div>
  <div class="col-2 mt-2"><p class="style10">  तारीख :</p></div>
  <div class="col-4 mt-2"><p class="style10"><?php echo $row6['i'];?></div>
  <div class="col-2 mt-2"><p class="style10">  साक्षीदारांचे नाव व सही  :</p></div>
  <div class="col-4 mt-2"> <p class="style10"><?php echo $row6['j'];?></div>
  <div class="col-2 mt-2"><p class="style10">  पत्ता :</p></div>
  <div class="col-4 mt-2"> <p class="style10"><?php echo $row6['k'];?></div>
...
<table class="table table-hover text-center">
  ...
  <tr>
   ...
   <div class="col-6">
   <h1 class="style3  style10"> Date : <?php echo $row6['l'];?> </h1>
	 
	   <h1>
   </div>
   <div class="col-6">
<h1 class="style3  style10"> ( Patient / Relative Signature ) :<?php echo $row6['m'];?>  </h1>
