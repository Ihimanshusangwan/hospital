...
<body class="m-2">
    ...
    <div class="row">
                    ...
                    <div class="col-4"><?php echo $c_de['0'];?></div>
                    <div class="col-1">वय :</div>
                    <div class="col-5"><?php echo $c_de['1'];?></div>
                    <div class="col-1">मी</div>
                    <div class="col-11"><?php echo $c_de['2'];?></div>
                    <div class="col-2">राहणार :</div>
                    <div class="col-4"><?php echo $c_de['3'];?></div>
                    ...
                    <div class="col-4"><?php echo $c_de['4'];?></div>
                    <div class="col-1">तारीख :</div>
                    <div class="col-3"><?php echo $c_de['5'];?></div>
                    <div class="col-2"></div>
                    <div class="col-1">नाव :</div>
                    <div class="col-5"><?php echo $c_de['6'];?></div>
                    ...
                    <div class="col-5"></div>
                    <div class="col-3">रुग्ण / नातेवाईक सही</div>
                    <div class="col-4"><?php echo $c_de['7'];?></div>
                    ...
                    <div class="col-1">तारीख :</div>
                    <div class="col-3"><?php echo $c_de['8'];?></div>
                    <div class="col-1"></div>
                    <div class="col-3">रूग्ण / नातेवाईक सही</div>
                    <div class="col-4"><?php echo $c_de['9'];?></div>
                    ...
                    <div class="col-1">तारीख :</div>
                    <div class="col-3"><?php echo $c_de['10'];?></div>
                    <div class="col-2"></div>
                    <div class="col-3">रूग्ण / नातेवाईक सही</div>
                    <div class="col-3"><?php echo $c_de['11'];?></div>
