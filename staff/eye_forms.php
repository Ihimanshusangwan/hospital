...
<body>
    ...
    <div class="container">
      ...
      <a href="admission.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Admission Form</button></a>
      <a href="discharge.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Discharge Form</button></a>
    <a href="otNotes.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Observation Chart</button></a>
    <a href="continuation.php?id=<?php echo $id; ?>"> <button class="btn btn-primary m-2">Continuation Sheet</button></a>
    <a href="consumable_acquisition_form.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Consumable Acquisition </button></a>
    <a href="Pre-operative_Checklist.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Pre-Operative Checklist</button></a>
    <a href="OT.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">OT Notes</button></a>
    <a href="pre_operative_anesthesia.php?id=<?php echo $id; ?>"><button class="btn btn-primary m-2">Pre-Operative Assessment by Anesthetist</button></a>
