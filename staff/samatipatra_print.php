...
<body class="m-2">
    ...
    <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6"></div>
                        <div class="col-6">UHID No:<?php echo $res2['uhid']; ?></div>
                        <div class="col-6"></div>
                        <div class="col-6">IPD No:<?php echo $res2['ipd']; ?></div>
                       <div class="col-12 mt-1">प्रमुख शल्यचिकित्सक/ प्रमुख (मध्यस्थ) सहाय्यक : डॉ. :<?php echo $a_de['1'];?></div>
                        <div class="col-12 my-2">रूग्णाविषयी माहिती</div>
                        <div class="col-6 mt-1">नांव : श्री / सौ. / कु <?php echo $res['name']; ?></div>
                        <div class="col-6 mt-1">वय: <?php echo $res['age']; ?> वर्ष:</div>
                        <div class="col-6 mt-1">पत्ता:<?php echo $res['address']." , ".$res['taluka']." , ".$res['district']; ?>
                        </div>
                        <div class="col-6 mt-1"> रूग्णाचे मासिक उत्पन्न :<?php echo $a_de['3'];?></div>
                        <div class="col-12 mt-1">रुग्णाचे पालक / प्रतिनीधी बद्दल माहिती नांव : श्री. /सौ. / श्रीमती-<?php echo $a_de['4'];?></div>
                        <div class="col-6 mt-1">पत्ता:<?php echo $a_de['5'];?></div>
                        <div class="col-6 mt-1"> फोन.:<?php echo $a_de['6'];?></div>
                        <div class="col-6 mt-1">रुग्णाशी नाते :<?php echo $a_de['7'];?></div>
                        <div class="col-6 mt-1">नियोजित शल्यचिकित्सा दिनांक :<?php echo $a_de['8'];?></div>
                        <div class="col-12 mt-1">प्रास्तावित उपायपद्दती / नियोजित शल्यचिकित्सा / उपचार पध्दती :<?php echo $a_de['9'];?></div>
                        <div class="col-6 mt-1">अ.<?php echo $a_de['10'];?></div>
                        <div class="col-6 mt-1">ब.<?php echo $a_de['11'];?></div>
                        ...
                        <div class="col-6 mt-4">संमतीची दिनांक व वेळ :<?php echo $a_de['12'];?></div>
                        <div class="col-6 mt-4">पेशंट/पालकाची सही / अंगठा :<?php echo $a_de['13'];?></div>
                        <div class="col-6 mb-4"></div>
                        <div class="col-6 mt-1 mb-4"> पेशंट / पालकाचे नाव:<?php echo $a_de['14'];?></div>
                        <hr>
                        <div class="col-6">Doctor / delegate Statement: I have explained the procedure to the patient
                            ...
                            <div class="row">
                                <div class="col-12">Other procedure :<?php echo $a_de['15'];?></div>
                            </div>
                            <hr>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-12"><?php echo $a_de['17'];?></div>
                                ...
                                <div class="col-12 mt-1"> Name & Sign of Interpreter:<?php echo $a_de['18'];?></div>
                                <div class="col-12 mt-1">Date & Time :<?php echo $a_de['19'];?>
                                </div> <br>
                            </div>
                            <hr>
                    ...
                    <div class="row">
                        <div class="col-6">(१) साक्षीदाराची नांव व सही :<?php echo $a_de['20'];?></div>
                        <div class="col-6">(२) साक्षीदाराची नांव व सही :<?php echo $a_de['21'];?></div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12"> प्रभारी डॉक्टर/प्रमुख शल्यचिकित्सक :<?php echo $a_de['22'];?></div>
                                <div class="col-12"> प्रमुख सहाय्यकाची स्वाक्षरी :<?php echo $a_de['23'];?></div>

                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12"> पेशंट/पालकाची सही/अंगठा :<?php echo $a_de['24'];?></div>
                                <div class="col-12"> पेशंट / पालकाचे नाव :<?php echo $a_de['25'];?></div>
                            </div>
                        </div>
                    </div>
                </div>
