...
<body>
  ...
  <div class="container">
    ...
    <a class="btn btn-success m-2" href="staff_Page.php">Dashboard</a>
    <h3 class="text-center text-dark mt-3">Gynec Forms</h3>
    <div class="row">
      <div class="col-md-3">
    ...
    <table class="table table-borderless">
      <tr>
        <td>
          <a href="autoclave.php?id=<?php echo $id; ?>"><button class="btn btn-primary mb-2">AutoClave Register
            </button></a>
        </td>
        <td>
          <a href="evacuation.php?id=<?php echo $id; ?>"><button class="btn btn-primary mb-2">Evacuation Register
            </button></a>
        </td>
        <td>
          <a href="fumigation.php?id=<?php echo $id; ?>"><button class="btn btn-primary mb-2">Fumigation Register</button></a>
        </td>
        <td>
