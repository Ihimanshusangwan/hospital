...
if(isset($_GET['date'])){
  ...
  if(isset($_GET['month'])){
    ...
    $sql3 = "SELECT * FROM opd_register WHERE date LIKE '%$searchMonth%';";
                    $data3 = $conn->query($sql3);
  }
...
<body class="m-2">
    ...
    <div id="button">
        ...
        <?php 
            if(isset($searchDate)){
                echo<<<back
                <a href="opd_register.php?date=$searchDate" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
back;
            }
            if(isset($searchMonth)){
                echo<<<back
                <a href="opd_register.php?month=$searchMonth" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
back;
            }
        ?>
    </div>
