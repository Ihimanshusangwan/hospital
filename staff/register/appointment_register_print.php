...
if(isset($_GET['date'])){
  ...
  if(isset($_GET['month'])){
    ...
    $sql3 = "SELECT * FROM appointment_register WHERE date LIKE '%$searchMonth%';";
                    $data3 = $conn->query($sql3);
  }
...
<body class="m-2">
    ...
    <div id="button">
        ...
        <?php 
            if(isset($searchDate)){
                echo<<<back
                <a href="appointment_register.php?date=$searchDate" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
back;
            }
            if(isset($searchMonth)){
                echo<<<back
                <a href="appointment_register.php?month=$searchMonth" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
back;
            }
        ?>
    </div>
    <?php include_once("../../header/images.php") ?>
    <h3 class="text-center text-dark my-3 ">Appointment  Register</h3>
    <hr />
    <div class="row">
        <div class="col-12">
