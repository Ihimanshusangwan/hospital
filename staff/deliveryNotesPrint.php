...
<div class="form-group">
  ...
  <span class="text-muted">If yes, Dose <?php echo $data[26];?></span>
</div>
...
<h3 class="text-center  ">Identification for Baby </h3>
<div class="container">
  <div class="row justify-content-center">
    <div class="col-10" style='border:1px solid black; height:20rem;'>
