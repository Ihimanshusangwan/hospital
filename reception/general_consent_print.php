...
<div id="button">
        ...
        <a href="general_consent.php?id=<?php echo $id; ?>" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
    </div>
        ...
        <form method="POST">
            <table class="table border border-dark">
                ...
                <tr>
                    ...
                    <td> <?php echo $res6['sign_1']; ?>
                    </td>
                    <td> <?php echo $res6['name_1']; ?>
                    </td>
                    <td> <?php echo $res6['date_1']; ?>
                    </td>
                    <td> <?php echo $res6['time_1']; ?>
                    </td>
                </tr>
                <tr>
                    <td> <label class="style11">Witness (Relation with Patient / साक्षीदार(रुग्णाशी नाते ))
                    </td>
                    <td> <?php echo $res6['sign_2']; ?>
                    </td>
                    <td> <?php echo $res6['name_2']; ?>
                    </td>
                    <td> <?php echo $res6['date_2']; ?>
                    </td>
                    <td> <?php echo $res6['time_2']; ?>
                    </td>
                </tr>
                <tr>
                    <td><label class="style11">Doctor /डॉक्टर</label> </td>
                    <td> <?php echo $res6['sign_3']; ?>
                    </td>
                    <td> <?php echo $res6['name_3']; ?>
                    </td>
                    <td> <?php echo $res6['date_3']; ?>
                    </td>
                    <td> <?php echo $res6['time_3']; ?>
                    </td>
                </tr>
                <tr>
                    <td class="style11">Anesthetist / भूलतज्ञ </td>
                    <td> <?php echo $res6['sign_4']; ?></td>
                    <td> <?php echo $res6['name_4']; ?></td>
                    <td> <?php echo $res6['date_4']; ?></td>
                    <td> <?php echo $res6['time_4']; ?></td>
                </tr>
                <tr>
                    <td class="style11">Interpreter / माहिती समजावून सांगणारे </td>
                    <td> <?php echo $res6['sign_5']; ?></td>
                    <td> <?php echo $res6['name_5']; ?></td>
                    <td> <?php echo $res6['date_5']; ?></td>
                    <td> <?php echo $res6['time_5']; ?></td>
                </tr>
            </table>
        </form>
    </div>
