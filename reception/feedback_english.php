...
if(isset($_POST['save'])){
  ...
  $query5 = "UPDATE `feedback_english` SET
`r_1` = '$r_1',
      `r_2` = '$r_2',
      `r_3` = '$r_3',
      `r_4` = '$r_4',
...
<body class="m-2">
    <div class="container shadow-lg rounded">
        <div id="button">
            ...
            <a href="feedback_english_print.php?id=<?php echo $id; ?>" class="btn btn-info mt-4 btn-danger"
                id="dashboard">print</a>
        </div>
        <h1 class="text-center text-danger mt-3">
            <?php echo $title['so'] ?>
        </h1>
        <h3 class="text-center text-dark my-3 ">PATIENT FEEDBACK FORM </h3>
        <div class="row">
            <div class="col-md-3">
        ...
        <form method="post">
            ...
            <div>
                ...
                <table width="100%">
                    ...
                    <th width="8%">A Excellent</th>
                    <th width="8%">B Very Good</th>
                    <th width="8%">C Good</th>
                    <th width="8%">D Average</th>
                    <th width="8%">E Poor</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline mx-4">
                                <input class="form-check-input" type="radio" name="r_1" id="inlineRadio2"
                                    <?php echo $res6['r_1']=='E'?'checked':''; ?> value="E">
                    ...
                    <tr>
                        ...
                        <td><span class="style23">What is your experience about medical treatment, about doctors &
                                health care
    ...
    <tr>
        ...
        <td><span class="style23">How do you rate promptness of care, courtesy and politeness What is your experience
                about services of paramedical &
    ...
    <tr>
        ...
        <td>
            <p class="style23">How do you rate the cleanliness in the Hospital OPD, Wards, Premises & Toilets?</p>
        </td>
