...
<body>
    ...
    <div class="container">
        <button class="btn btn-success m-2" id="dashboard" cookieName="other-form-referer">Dashboard</button>
      <h1 class="text-center text-danger mt-3"><?php echo $title['rm']?></h1>
      <h3 class="text-center text-dark mt-3">Other forms</h3>
      <div class="row">
        <div class="col-md-3">
      ...
      <a href="premission.php?id=<?php echo $id;?>"><button class="btn btn-primary mb-1">permission Consent</button></a>
    <a href="feedback_english.php?id=<?php echo $id;?>"><button class="btn btn-primary mb-1">Feedback form English</button></a>
    <a href="feedback_marthi.php?id=<?php echo $id;?>"><button class="btn btn-primary mb-1">Feedback form Marathi</button></a>
