...
<body>
    <div class="container">
        <div id="button">
            ...
            <a href="ipd_bill.php?id=<?php echo $id; ?>" class="btn btn-info mt-4 noprint" id="dashboard">Dashboard</a>
        </div>
    ...
    <div class="container mt-5">
        ...
        <h5 style="text-align: right; margin-right: 2em;">Discount : <?php echo $res3['discount']; ?>.00</h5>
        <h5 style="text-align: right; margin-right: 2em;">Grand Total :
            <?php echo $res3['payable']; ?>.00
        </h5> <br><br><br>
