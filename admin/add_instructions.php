...
if(isset($_POST['instruction'])){
    ...
    $sql = "INSERT INTO  in_view (instruction) VALUES ('$instruction')";
...
<body>
   ...
   <div class="row">
        ...
        <div class="col-8">
            <input type="text" class="form-control " name="instruction" style="margin:20px;" name="" id="">
        </div>
   </div>
