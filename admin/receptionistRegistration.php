...
<body>
  <div class="container mb-4">
    ...
    <h5 class="text-center mt-3">Receptionist Registration Form</h5>
    <div class="row p-4 pt-4">
      <div class="col shadow-lg rounded m-2 p-4">
        <div class="text-info text-center ml-2">Receptionist Details:</div>
        <?php
        require("connect.php");
        ...
        if (isset($_POST['submit'])) {
          ...
          if ( empty($mailErr) && empty($passErr)) {
            ...
            $sql = "INSERT INTO receptionists (name, address, taluka, district, age, sex,dob, reg_date, mobile, email, password)
    VALUES ('$name', '$address', '$taluka', '$district', '$age', '$sex', '$dob_date', '$reg_date', '$mobile', '$mail', '$pass')";
        ...
        <form id="form" action="" method="POST" enctype="multipart/form-data">
          <div class="form-group m-2">
            <label for="name">Name of Receptionist:</label>
