...
function addItem1() {
  ...
  html += "<option value='Powder' >Powder</option>";
  html += "<option value='Oinment/cream' >Oinment/cream</option>";
  html += "</select>";
  html += "</td>";
  html += "<td>";
  html +=
...
function change1(btn) {
  ...
  if (e === "E/D") {
    ...
    html += "<option value='Sachet' >Sachet</option>";
    html += "<option value='Inj'>Inj</option>";
    html += "<option value='Powder' selected >Powder</option>";
    html += "<option value='Oinment/cream'  >Oinment/cream</option>";
    html += "</select>";
    html += "</td>";
    html += "<td>";
    ...
    html += "<option value='Inj'>Inj</option>";
    html += "<option value='Powder'  >Powder</option>";
    html += "<option value='Oinment/cream' selected >Oinment/cream</option>";
    html += "</select>";
    html += "</td>";
    html += "<td>";
    html +=
