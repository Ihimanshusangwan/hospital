...
<body>
   ...
   <div class="row">
    <div class="col-3">
   <label for="" class="form-label " style="margin-top:20px;" ><strong>Add Cheif Complaints :</strong> </label>
   </div>
    <div class="col-8">
  ...
  <input type="submit" class="btn btn-primary"  style="margin:20px;margin-right:47px;"value="Add">
   ...
   <div class="card shadow-lg m-3 " style="width:50rem;">
        <p class="m-3 text-center"><strong>Added Cheif Complaints</strong></p><hr>
