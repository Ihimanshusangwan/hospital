...
if(isset($_GET['delete_id'])){
    ...
    $delete_sql = "DELETE FROM add_invest_imaging WHERE id = $delete_id AND dr_id = {$_SESSION['doctor_id']}";
...
<body>
    ...
    <div class="container" style="display:flex;justify-content:center;">
        <div class="card shadow-lg m-3" style="width:50rem;">
            <p class="mx-3 text-center"><strong>Added Investigation Imaging</strong></p>
